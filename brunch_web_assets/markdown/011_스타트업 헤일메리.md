...
책의 저자 앤디 위어는 정식으로 작가로 데뷔하지 않았다. 컴퓨터프로그래머로 일하는 중 자기 웹사이트에 연재를 올리며 시작하였다. 출판의 문을 두드리던 그는 무료로 인터넷에 글을 올렸고, 독자들이 먼저 반응했다. 그만의 헤일메리가 결국 그를 베스트셀러 작가로 만든 것이다.<!-- CATEGORY_NAV_START -->
<style>
