...
<div class="category-nav-wrap">
  <a href="/brunch_web_assets/markdown/553_%EA%B8%B0%ED%9A%8D%EC%9D%80%20%EB%AA%87%20%ED%98%95%EC%8B%9D.html" class="cat-nav-item cat-nav-left"><span class="cat-nav-label">카테고리의 이전글</span><span class="nav-title">기획은 몇 형식?</span></a>
  <a href="/brunch_web_assets/markdown/573_%EC%82%AC%EA%B8%B0%EC%9D%98%20%EC%A0%91%EA%B7%BC%EB%B2%95.html" class="cat-nav-item cat-nav-right"><span class="nav-title">사기의 접근법</span><span class="cat-nav-label">카테고리의 다음글</span></a>
</div>
<!-- CATEGORY_NAV_END -->