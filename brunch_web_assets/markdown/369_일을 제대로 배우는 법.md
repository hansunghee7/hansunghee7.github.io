...
1.
 ...
 실력을 높이고 싶다면, 실력이 높은 사람을 만나야 한다. 돈을 받으면서 배울 수 있는 직장이면 제일 좋다. 그러기 위해서는 본인이 어느 정도 실력이 되어야 한다. 학원이든 트레바리든 커피챗이든 책이든 유튜브든 닥치는 대로 본인이 필요한 기본 실력을 키워서 그 들을 만나서 얘기를 나누고 그 일을 매일 같이 해라. 그게 일을 배우는 최고의 방법이다.<!-- CATEGORY_NAV_START -->
<style>
