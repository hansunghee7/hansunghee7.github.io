...
<div class="category-nav-wrap">
  <div></div>
  <a href="/brunch_web_assets/markdown/027_AI%EC%9D%98%20%EB%85%B8%EC%98%88%EA%B0%80%20%EC%95%84%EB%8B%8C%20%EC%A3%BC%EC%9D%B8%EC%9D%B4%20%EB%90%98%EB%8A%94%20%EB%B2%95.html" class="cat-nav-item cat-nav-right"><span class="nav-title">AI의 노예가 아닌 주인이 되는 법</span><span class="cat-nav-label">카테고리의 다음글</span></a>
</div>
<!-- CATEGORY_NAV_END -->