...
cover_image: "../images/191_AI하드웨어, GPU와 NPU 그리고 FPGA의 차이점_cover.jpg"
...
![ai_difference_between_deep_learning_training_inference.jpg](../images/191_AI하드웨어, GPU와 NPU 그리고 FPGA의 차이점_img_1.jpg)
...
![cpu+gpu-01.png](../images/191_AI하드웨어, GPU와 NPU 그리고 FPGA의 차이점_img_2.jpg)
...
![71bb10eb8641e.png](../images/191_AI하드웨어, GPU와 NPU 그리고 FPGA의 차이점_img_3.jpg)
...
![fpga-implementaion-flow-diagram:1920-1080?wid=864&hei=486&fmt=webp-alpha](../images/191_AI하드웨어, GPU와 NPU 그리고 FPGA의 차이점_img_4.jpg)

## AI 하드웨어 선택과 미래

결국 AI 하드웨어는 쓰임새에 따라 선택하는 것이 중요합니다. 대규모 학습이 필요하다면 GPU나 구글 TPU 같은 고성능 가속기를 써야겠죠. 저전력으로 실시간 추론을 해야 한다면 NPU나 FPGA가 낫고요.

![img1.jpg](../images/191_AI하드웨어, GPU와 NPU 그리고 FPGA의 차이점_img_5.jpg)
