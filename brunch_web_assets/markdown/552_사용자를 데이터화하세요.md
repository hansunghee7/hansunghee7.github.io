...
<div class="category-nav-wrap">
  <a href="/brunch_web_assets/markdown/551_%EB%82%A8%EB%93%A4%EC%9D%80%20%EB%8B%A4%20%ED%96%89%EB%B3%B5%ED%95%9C%20%EA%B1%B0%20%EA%B0%99%EC%95%84%EC%9A%94.html" class="cat-nav-item cat-nav-left"><span class="cat-nav-label">카테고리의 이전글</span><span class="nav-title">남들은 다 행복한 거 같아요.</span></a>
  <a href="/brunch_web_assets/markdown/554_O%20or%20X.html" class="cat-nav-item cat-nav-right"><span class="nav-title">O or X</span><span class="cat-nav-label">카테고리의 다음글</span></a>
</div>
<!-- CATEGORY_NAV_END -->