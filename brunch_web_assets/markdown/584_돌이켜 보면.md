...
<div class="category-nav-wrap">
  <a href="/brunch_web_assets/markdown/579_%EB%93%B1%EC%82%B0.html" class="cat-nav-item cat-nav-left"><span class="cat-nav-label">카테고리의 이전글</span><span class="nav-title">등산</span></a>
  <a href="/brunch_web_assets/markdown/588_%EC%A2%8B%EC%9D%80%20%EA%B8%B0%ED%9A%8D%EC%9E%90%EB%8A%94.html" class="cat-nav-item cat-nav-right"><span class="nav-title">좋은 기획자는</span><span class="cat-nav-label">카테고리의 다음글</span></a>
</div>
<!-- CATEGORY_NAV_END -->