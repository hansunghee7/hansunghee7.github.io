...
전문가의 여유는 그 지독한 질문에 답을 찾아가는 과정 끝에 주어지는 선물 같은 것이니까요.https://www.yes24.com/product/goods/193444437
<!-- PROMO_BANNER_START -->
...
<div class="category-nav-wrap">
  <a href="/brunch_web_assets/markdown/012_%EB%88%84%EA%B0%80%20%EC%A3%BC%EC%9D%B8%EC%9D%B8%EA%B0%80%EC%9A%94.html" class="cat-nav-item cat-nav-left"><span class="cat-nav-label">'기획일상'의 이전글</span><span class="nav-title">누가 주인인가요?</span></a>
  <a href="/brunch_web_assets/markdown/015_%EC%BB%A4%EB%A6%AC%EC%96%B4%EA%B0%80%20%EA%BC%AC%EC%9D%B4%EB%8A%94%20%EC%9D%B4%EC%9C%A0.html" class="cat-nav-item cat-nav-right"><span class="nav-title">커리어가 꼬이는 이유</span><span class="cat-nav-label">'기획일상'의 다음글</span></a>
</div>
<!-- CATEGORY_NAV_END -->