...
<div class="category-nav-wrap">
  <a href="/brunch_web_assets/markdown/276_%EC%9A%B4%EB%AA%85%EA%B3%BC%20%EB%82%98%EC%9D%98%20%EC%84%A0%ED%83%9D.html" class="cat-nav-item cat-nav-left"><span class="cat-nav-label">카테고리의 이전글</span><span class="nav-title">운명과 나의 선택</span></a>
  <a href="/brunch_web_assets/markdown/279_%EA%B6%A4%EB%B3%80%EC%97%90%20%EB%8C%80%EC%9D%91%ED%95%98%EB%8A%94%20%EB%B2%95.html" class="cat-nav-item cat-nav-right"><span class="nav-title">궤변에 대응하는 법</span><span class="cat-nav-label">카테고리의 다음글</span></a>
</div>
<!-- CATEGORY_NAV_END -->