...
![모델 병렬화와 데이터 병렬화의 처리 구조를 비교한 다이어그램](//img1.kakaocdn.net/thumb/R1280x0.fpng/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/hIh9Evp_hYpVEAndcGKVME8aoMY.png)
...
![PyTorch DDP의 랭크 간 브로드캐스트와 결과 취합 과정을 나타낸 도식](//img1.kakaocdn.net/thumb/R1280x0.fpng/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/EVr1ifNSLLwbYp_06eqtuSm3A5k.png)PyTorch DDP
...
![TensorFlow MirroredStrategy의 워커 간 동기화 구조를 보여주는 다이어그램](//img1.kakaocdn.net/thumb/R1280x0.fjpg/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/xy9ubBw1ukQ9mlRAb3iCR_Q7Dbo.jpg)MirroredStrategy
...
![데이터 병렬화와 모델 병렬화의 처리 흐름을 비교한 도식](//img1.kakaocdn.net/thumb/R1280x0.fjpg/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/K-ORuRWZPNJshnzkZuseBUpKddI.jpg)
...
<div class="category-nav-wrap">
  ...
  <a href="/log_assets/markdown/127_%EB%B6%84%EC%82%B0%20%ED%95%99%EC%8A%B5%2C%20AI%20%EB%B9%84%EC%A6%88%EB%8B%88%EC%8A%A4%20%EA%B2%BD%EC%9F%81%EB%A0%A5%EC%9D%84%20%EC%A2%8C%EC%9A%B0%ED%95%98%EB%8A%94%20%ED%95%B5%EC%8B%AC%20%EA%B8%B0%EC%88%A0.html" class="cat-nav-item cat-nav-right"><span class="nav-title">분산 학습, AI 비즈니스 경쟁력을 좌우하는 핵심 기술</span><span class="cat-nav-label">다음글 ❯</span></a>
</div>
<!-- CATEGORY_NAV_END -->
