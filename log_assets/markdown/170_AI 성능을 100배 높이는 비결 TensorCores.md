...
<img width="600" height="337" loading="lazy" src="/log_assets/images/170_AI 성능을 100배 높이는 비결 TensorCores_img_1.jpg" alt="3x2 행렬과 2x3 행렬의 곱셈 연산 과정 도식">
...
<img width="1280" height="727" loading="lazy" src="/log_assets/images/170_AI 성능을 100배 높이는 비결 TensorCores_img_2.jpg" alt="엔비디아 텐서 코어의 행렬 연산 구조를 나타낸 그래픽">
...
<img width="624" height="375" loading="lazy" src="/log_assets/images/170_AI 성능을 100배 높이는 비결 TensorCores_img_3.jpg" alt="팬스칼 대비 튜링 텐서 코어의 정밀도별 처리량 비교 그래프">
