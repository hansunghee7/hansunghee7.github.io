...
<div class="category-nav-wrap">
  ...
  <a href="/log_assets/markdown/133_Drop-off, 사용자가 떠나는 순간을 포착하는 방법.html" class="cat-nav-item cat-nav-right"><span class="nav-title">Drop-off, 사용자가 떠나는 순간을 포착하는 방법</span><span class="cat-nav-label">다음글 ❯</span></a>
</div>
<!-- CATEGORY_NAV_END -->
