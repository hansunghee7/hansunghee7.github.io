...
category: 'UX의 언어들'
image: '/log_assets/images/140_어포던스 이 버튼, 왜 누르고 싶을까 그 비밀_cover.jpg'
date_string: 'May 15. 2025'
date: 2025-05-15
keywords: '어포던스 디자인, UX 심리학, 인터랙션 디자인'
about: 'UX 디자인, 인터랙션 설계'
---
...
![버튼은 누르고 스위치는 젖히고 손잡이는 돌리는 손동작을 그린 그림](//img1.kakaocdn.net/thumb/R1280x0.fjpg/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/89GOPTyb-zwnpVfoP5tS4J45h5g.jpg)
...
![구글 로그인 화면에서 텍스트박스와 버튼의 어포던스, 라벨의 시그니파이어를 표시한 다이어그램](//img1.kakaocdn.net/thumb/R1280x0.fjpg/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/rLJSYzYGA8oJmpYznVkZzLCoYmQ.jpg)

애플: iOS에서는 스위치, 버튼, 슬라이더 등이 실제 사물의 촉감을 시각적으로 재현하여 사용자가 '어떻게 조작하는지'를 즉시 알 수 있도록 합니다.

![아이폰 스위치 토글의 활성화, 비활성화 상태를 보여주는 아이콘](//img1.kakaocdn.net/thumb/R1280x0.fpng/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/gbalB6U0mxxzH4iE416tK6mmQyE.png)
...
![머티리얼 디자인의 어포던스와 시그니파이어 개념을 정리한 9컷 손글씨 스케치노트](//img1.kakaocdn.net/thumb/R1280x0.fpng/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/7otMfuJsPGrOvCDDb2u7Ok-twLQ.png)
