...
<img width="647" height="376" loading="lazy" src="/log_assets/images/189_칸반, 애자일의 Just In Time_img_1.jpg" alt="도요타 생산 현장에서 칸반이 부품 제작과 회수 흐름을 지시하는 과정 도식">
...
<img width="600" height="496" loading="lazy" src="/log_assets/images/189_칸반, 애자일의 Just In Time_img_2.jpg" alt="백로그부터 완료까지 열로 구분된 칸반 보드 예시 화면">
...
<img width="1280" height="719" loading="lazy" src="/log_assets/images/189_칸반, 애자일의 Just In Time_img_3.jpg" alt="스프린트 순환 구조의 스크럼과 열 흐름 방식의 칸반을 비교한 인포그래픽">
