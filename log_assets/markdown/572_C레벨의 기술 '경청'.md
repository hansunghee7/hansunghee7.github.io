...
<div class="category-nav-wrap">
  <a href="/log_assets/markdown/578_프로덕트 회사의 야근 전략.html" class="cat-nav-item cat-nav-left"><span class="cat-nav-label">❮ 이전글</span><span class="nav-title">프로덕트 회사의 야근 전략</span></a>
  <a href="/log_assets/markdown/566_대표의 이름을 빨간색으로 쓰진 마세요.html" class="cat-nav-item cat-nav-right"><span class="nav-title">대표의 이름을 빨간색으로 쓰진 마세요.</span><span class="cat-nav-label">다음글 ❯</span></a>
</div>
<!-- CATEGORY_NAV_END -->
