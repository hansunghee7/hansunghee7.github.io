...
<img width="600" height="290" loading="lazy" src="/log_assets/images/102_깨끗한 인터페이스, Clean UI의 반전_img_1.jpg" alt="iOS 7의 플랫 디자인 홈 화면을 보여주는 아이폰 다섯 대">
...
<img width="600" height="450" loading="lazy" src="/log_assets/images/102_깨끗한 인터페이스, Clean UI의 반전_img_2.jpg" alt="주식 매수 주문의 스와이프 확인 인터페이스">
...
<img width="1280" height="640" loading="lazy" src="/log_assets/images/102_깨끗한 인터페이스, Clean UI의 반전_img_3.jpg" alt="드롭다운 버튼 등 미니멀한 UI 컴포넌트 모음">
