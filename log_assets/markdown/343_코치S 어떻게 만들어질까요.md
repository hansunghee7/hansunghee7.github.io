...
<div class="category-nav-wrap">
  <a href="/log_assets/markdown/332_'코치S' 브런치북을 출간하였습니다.html" class="cat-nav-item cat-nav-left"><span class="cat-nav-label">❮ 이전 화</span><span class="nav-title">코치S' 브런치북을 출간하였습니다.</span></a>
  <a href="/log_assets/markdown/376_코치S ‘목표는 몇 개’ 편 해설.html" class="cat-nav-item cat-nav-right"><span class="nav-title">코치S ‘목표는 몇 개’ 편 해설</span><span class="cat-nav-label">다음 화 ❯</span></a>
</div>
<!-- CATEGORY_NAV_END -->
