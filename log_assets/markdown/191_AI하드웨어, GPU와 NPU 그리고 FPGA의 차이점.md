...
<img width="1080" height="608" loading="lazy" src="//img1.kakaocdn.net/thumb/R1280x0.fjpg/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/BJdzPnC7MCUKoAopQtIlii3ABjs.jpg" alt="신경망 모델이 학습 단계를 거쳐 추론 단계로 이어지는 딥러닝 과정 도식">
...
<img width="901" height="701" loading="lazy" src="//img1.kakaocdn.net/thumb/R1280x0.fpng/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/TFUwfRU6BI_EBE_xgTL4jyQ1Dgk.png" alt="적은 수의 코어를 가진 CPU와 수천 개의 코어를 가진 GPU 구조 비교 그림">
...
<img width="608" height="161" loading="lazy" src="//img1.kakaocdn.net/thumb/R1280x0.fpng/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/FQ0wEuGDG37Pp5mEJk_1boR3X0k.png" alt="CPU, GPU, NPU의 내부 연산 유닛 배치를 비교한 구조도">
...
<img width="864" height="486" loading="lazy" src="//img1.kakaocdn.net/thumb/R1280x0.fwebp/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/H0FXpHp93_bqRw48ZkXzMh1Ujbc" alt="아키텍처 설계 파일부터 완성된 FPGA 칩까지 이어지는 FPGA 구현 흐름도">

## AI 하드웨어 선택과 미래

결국 AI 하드웨어는 쓰임새에 따라 선택하는 것이 중요합니다. 대규모 학습이 필요하다면 GPU나 구글 TPU 같은 고성능 가속기를 써야겠죠. 저전력으로 실시간 추론을 해야 한다면 NPU나 FPGA가 낫고요.

<img width="987" height="492" loading="lazy" src="//img1.kakaocdn.net/thumb/R1280x0.fjpg/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/FYZl7UYQAlrPGtkbHrDDPBFWl3Y.jpg" alt="CPU, GPU, FPGA, ASIC의 유연성과 비용 트레이드오프를 비교한 인포그래픽">
