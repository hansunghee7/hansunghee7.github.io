...
![신경망 모델이 학습 단계를 거쳐 추론 단계로 이어지는 딥러닝 과정 도식](//img1.kakaocdn.net/thumb/R1280x0.fjpg/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/BJdzPnC7MCUKoAopQtIlii3ABjs.jpg)
...
![적은 수의 코어를 가진 CPU와 수천 개의 코어를 가진 GPU 구조 비교 그림](//img1.kakaocdn.net/thumb/R1280x0.fpng/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/TFUwfRU6BI_EBE_xgTL4jyQ1Dgk.png)
...
![CPU, GPU, NPU의 내부 연산 유닛 배치를 비교한 구조도](//img1.kakaocdn.net/thumb/R1280x0.fpng/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/FQ0wEuGDG37Pp5mEJk_1boR3X0k.png)
...
![아키텍처 설계 파일부터 완성된 FPGA 칩까지 이어지는 FPGA 구현 흐름도](//img1.kakaocdn.net/thumb/R1280x0.fwebp/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/H0FXpHp93_bqRw48ZkXzMh1Ujbc)

## AI 하드웨어 선택과 미래

결국 AI 하드웨어는 쓰임새에 따라 선택하는 것이 중요합니다. 대규모 학습이 필요하다면 GPU나 구글 TPU 같은 고성능 가속기를 써야겠죠. 저전력으로 실시간 추론을 해야 한다면 NPU나 FPGA가 낫고요.

![CPU, GPU, FPGA, ASIC의 유연성과 비용 트레이드오프를 비교한 인포그래픽](//img1.kakaocdn.net/thumb/R1280x0.fjpg/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/FYZl7UYQAlrPGtkbHrDDPBFWl3Y.jpg)
...
<div class="category-nav-wrap">
  <a href="/log_assets/markdown/199_AI%EC%8B%9C%EB%8C%80%20%EC%8A%88%ED%8D%BC%EC%BB%B4%ED%93%A8%ED%84%B0%EA%B0%80%20%ED%95%84%EC%9A%94%ED%95%9C%20%EC%9D%B4%EC%9C%A0.html" class="cat-nav-item cat-nav-left"><span class="cat-nav-label">❮ 이전글</span><span class="nav-title">AI시대 슈퍼컴퓨터가 필요한 이유</span></a>
