...
date: 2025-04-30
keywords: '희소 연산, 모델 가지치기, 경량화 추론'
about: 'AI 모델 경량화, 인프라 비용 절감'
---
...
![촘촘하게 연결된 Dense Graph가 희소 연산을 거쳐 Sparse Graph로 바뀌는 비교 이미지](//img1.kakaocdn.net/thumb/R1280x0.fpng/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/Vq3YPo-fHAhbyNk69LMLQjlM15g.png)
...
![가지치기 전후 신경망 구조를 비교해 불필요한 연결이 제거된 모습을 보여주는 그림](//img1.kakaocdn.net/thumb/R1280x0.fpng/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/9E3pnrFPjeirJM2VmleI0XNdWow.png)
