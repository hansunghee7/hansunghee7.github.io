...
![Stateless와 Stateful 서비스 구조를 피라미드 도식으로 비교한 그림](//img1.kakaocdn.net/thumb/R1280x0.fpng/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/IZTKLproT_F5GRZmy9J0pfY65X8.png)
...
![질의응답 파이프라인에서 쿼리 리라이팅을 적용한 구조를 비교한 논문 다이어그램](//img1.kakaocdn.net/thumb/R1280x0.fjpg/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/533ST6--Wi1V1K742kXk9O6Uf-o.jpg)
...
![구직 관련 질문에 대한 Related 추천 질문 목록 UI](//img1.kakaocdn.net/thumb/R1280x0.fpng/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/DnBQFtxcTpGs6a2tS27pUx9ZenA.png)
...
![스토리지와 스트리밍 데이터 API, 스트리밍 클라이언트 간 연결 구조를 나타낸 손그림 다이어그램](//img1.kakaocdn.net/thumb/R1280x0.fpng/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/374LlWSqZG57D2uVZa4c4M_NA8I.png)
