...
<img width="1280" height="870" loading="lazy" src="/log_assets/images/144_Perplexity#4 대화형 UX 구조와 쿼리 분기_img_1.png" alt="Stateless와 Stateful 서비스 구조를 피라미드 도식으로 비교한 그림">
...
<img width="1200" height="630" loading="lazy" src="/log_assets/images/144_Perplexity#4 대화형 UX 구조와 쿼리 분기_img_2.jpg" alt="질의응답 파이프라인에서 쿼리 리라이팅을 적용한 구조를 비교한 논문 다이어그램">
...
<img width="855" height="431" loading="lazy" src="/log_assets/images/144_Perplexity#4 대화형 UX 구조와 쿼리 분기_img_3.png" alt="구직 관련 질문에 대한 Related 추천 질문 목록 UI">
...
<img width="1103" height="465" loading="lazy" src="/log_assets/images/144_Perplexity#4 대화형 UX 구조와 쿼리 분기_img_4.png" alt="스토리지와 스트리밍 데이터 API, 스트리밍 클라이언트 간 연결 구조를 나타낸 손그림 다이어그램">
