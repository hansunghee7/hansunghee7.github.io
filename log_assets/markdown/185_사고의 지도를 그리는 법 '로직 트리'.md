...
category: '기획자의 프레임웍'
image: '/log_assets/images/185_사고의 지도를 그리는 법 로직 트리_cover.jpg'
date_string: 'Apr 1. 2025'
date: 2025-04-01
keywords: '로직 트리, 문제 해결 프레임워크, MECE 사고법'
about: '기획 프레임워크, 논리적 사고'
---
...
![포스트잇으로 목표에서 기회, 해결책까지 가지치기한 로직 트리 워크숍 사진](//img1.kakaocdn.net/thumb/R1280x0.fjpg/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/IOq2LE6WhD3CXHtr_H8-LKxsEhk.jpg)
...
![구글 클라우드 AI 도입 여부를 판단하는 의사결정 트리 다이어그램](//img1.kakaocdn.net/thumb/R1280x0.fpng/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/6TRhLxkaINgwMOe3AkbEtY4gJWQ.png)
...
<div class="category-nav-wrap">
  ...
  <a href="/log_assets/markdown/178_%27So%20What%2C%20Why%20So%27%20%EB%85%BC%EB%A6%AC%EC%97%90%20%EC%98%81%ED%98%BC%EC%9D%84%20%EB%B6%88%EC%96%B4%EB%84%A3%EB%8B%A4.html" class="cat-nav-item cat-nav-right"><span class="nav-title">'So What, Why So' 논리에 영혼을 불어넣다</span><span class="cat-nav-label">다음글 ❯</span></a>
</div>
<!-- CATEGORY_NAV_END -->
