...
![순전파와 역전파로 이루어진 AI 모델 학습 과정을 나타낸 다이어그램](//img1.kakaocdn.net/thumb/R1280x0.fjpg/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/LCQKkwCfIex6Q3QJRIj70zbAWq4.jpg)
...
![엣지 컴퓨팅 기반 저지연 추론 시스템 구성을 보여주는 다이어그램](//img1.kakaocdn.net/thumb/R1280x0.fjpg/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/ratP66FXMR4__ny3rmOAd9civfQ.jpg)
...
![학습 단계와 추론 단계의 차이를 보여주는 신경망 처리 과정 다이어그램](//img1.kakaocdn.net/thumb/R1280x0.fpng/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/89IQ6xFZDZ2C4RWWudSn5xhJ0gA.png)
...
<div class="category-nav-wrap">
  <a href="/log_assets/markdown/141_AI%EB%8D%B0%EC%9D%B4%ED%84%B0%EC%84%BC%ED%84%B0%20%ED%98%88%EA%B4%80%2C%20InfiniBandNVLink.html" class="cat-nav-item cat-nav-left"><span class="cat-nav-label">❮ 이전글</span><span class="nav-title">AI데이터센터 혈관, InfiniBand/NVLink</span></a>
