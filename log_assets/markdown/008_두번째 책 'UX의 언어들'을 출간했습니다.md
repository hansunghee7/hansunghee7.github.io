...
<div class="category-nav-wrap">
  <div></div>
  <a href="/log_assets/markdown/017_%EC%9A%94%EC%8B%9C%EA%B0%80%20%EB%A7%8C%EB%93%A0%20%20%27%EA%B7%BC%EC%84%B1%EC%9D%98%20%EC%8A%A4%EB%85%B8%EC%9A%B0%EB%B3%BC%27.html" class="cat-nav-item cat-nav-right"><span class="nav-title">017_요시가 만든  '근성의 스노우볼'</span><span class="cat-nav-label">다음글 ❯</span></a>
</div>
<!-- CATEGORY_NAV_END -->
