...
<img width="1200" height="675" loading="lazy" src="/log_assets/images/069_Predictive UX, 사용자의 다음 행동은_img_1.jpg" alt="시간대별로 개인화된 플레이리스트를 보여주는 스포티파이 데이라이스트 화면">
...
<img width="541" height="550" loading="lazy" src="/log_assets/images/069_Predictive UX, 사용자의 다음 행동은_img_2.jpg" alt="박물관 가는 길을 미리 안내하는 구글 나우 검색 및 지도 화면">
