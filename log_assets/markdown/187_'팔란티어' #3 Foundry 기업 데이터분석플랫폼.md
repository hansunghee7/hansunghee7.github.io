...
<img width="1280" height="715" loading="lazy" src="/log_assets/images/187_'팔란티어' #3 Foundry 기업 데이터분석플랫폼_img_1.webp" alt="팔란티어 파운드리의 온톨로지 계층 구조를 보여주는 3D 다이어그램">
...
<img width="1280" height="602" loading="lazy" src="/log_assets/images/187_'팔란티어' #3 Foundry 기업 데이터분석플랫폼_img_2.webp" alt="파운드리 리소스 관리 콘솔의 컴퓨트 사용량 및 스토리지 현황 대시보드">
...
<img width="1280" height="720" loading="lazy" src="/log_assets/images/187_'팔란티어' #3 Foundry 기업 데이터분석플랫폼_img_3.webp" alt="폐암 코호트 환자 데이터를 인구통계별로 분석한 파운드리 대시보드 화면">
...
<img width="1280" height="1148" loading="lazy" src="/log_assets/images/187_'팔란티어' #3 Foundry 기업 데이터분석플랫폼_img_4.jpg" alt="다양한 커넥터부터 클라우드, 데이터 통합, 분석 산출물까지 이어지는 파운드리 아키텍처 도식">
...
<img width="1280" height="720" loading="lazy" src="/log_assets/images/187_'팔란티어' #3 Foundry 기업 데이터분석플랫폼_img_5.jpg" alt="파운드리 위에 다수의 애플리케이션이 연결되는 구조를 표현한 슬라이드">
