...
<div class="category-nav-wrap">
  <a href="/log_assets/markdown/010_우리는 대화를 했을까.html" class="cat-nav-item cat-nav-left"><span class="cat-nav-label">❮ 이전글</span><span class="nav-title">우리는 대화를 했을까?</span></a>
  <a href="/log_assets/markdown/003_회의실에서 목소리가 큰 사람이 가장 위험할 수 있다.html" class="cat-nav-item cat-nav-right"><span class="nav-title">회의실에서 목소리가 큰 사람이 가장 위험할 수 있다</span><span class="cat-nav-label">다음글 ❯</span></a>
</div>
<!-- CATEGORY_NAV_END -->
