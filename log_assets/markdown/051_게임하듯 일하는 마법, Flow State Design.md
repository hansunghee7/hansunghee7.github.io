...
<img width="600" height="305" loading="lazy" src="/log_assets/images/051_게임하듯 일하는 마법, Flow State Design_img_1.jpg" alt="몰입 이론을 설명하는 심리학자 미하이 칙센트미하이 강연 장면">
...
<img width="610" height="350" loading="lazy" src="/log_assets/images/051_게임하듯 일하는 마법, Flow State Design_img_2.jpg" alt="지메일의 발송 취소 기능 설정 화면">
...
<img width="600" height="337" loading="lazy" src="/log_assets/images/051_게임하듯 일하는 마법, Flow State Design_img_3.jpg" alt="스포티파이 DJ 모드 기능 소개 화면">

## 몰입을 만드는 세 가지 조건

Flow State를 유도하려면 명확한 목표와 즉각적인 피드백(인스타그램의 '좋아요' 애니메이션), 도전과 실력의 균형(넷플릭스의 5초 자동재생 대기), 그리고 방해 요소 제거(노션의 집중 모드)가 필요합니다.
