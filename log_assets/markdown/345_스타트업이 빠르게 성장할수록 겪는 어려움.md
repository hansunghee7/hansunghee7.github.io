...
category: '스타트업 인사이트'
image: '/log_assets/images/345_스타트업이 빠르게 성장할수록 겪는 어려움_cover.jpg'
date_string: 'Aug 12. 2024'
date: 2024-08-12
keywords: '스타트업 스케일업 어려움, 조직 확장 커뮤니케이션, PMF 이후 성장통'
about: '스타트업 성장, 조직 설계, 스케일업'
---
...
<div class="category-nav-wrap">
  ...
  <a href="/log_assets/markdown/328_%EC%B0%BD%EC%97%85%20%EC%95%84%EC%9D%B4%ED%85%9C%20%EC%84%A0%EC%A0%95%20%EC%8B%9C%20%EC%A3%BC%EC%9D%98%ED%95%A0%20%EC%A0%90%EC%9D%80.html" class="cat-nav-item cat-nav-right"><span class="nav-title">창업 아이템 선정 시 주의할 점은?</span><span class="cat-nav-label">다음글 ❯</span></a>
</div>
<!-- CATEGORY_NAV_END -->
