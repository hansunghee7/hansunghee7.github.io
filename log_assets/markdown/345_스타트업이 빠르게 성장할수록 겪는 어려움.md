...
<div class="category-nav-wrap">
  <a href="/log_assets/markdown/361_UX 설계를 잘하는 법.html" class="cat-nav-item cat-nav-left"><span class="cat-nav-label">❮ 이전글</span><span class="nav-title">UX 설계를 잘하는 법</span></a>
  <a href="/log_assets/markdown/328_창업 아이템 선정 시 주의할 점은.html" class="cat-nav-item cat-nav-right"><span class="nav-title">창업 아이템 선정 시 주의할 점은?</span><span class="cat-nav-label">다음글 ❯</span></a>
</div>
<!-- CATEGORY_NAV_END -->
