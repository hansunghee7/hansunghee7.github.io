...
<div class="category-nav-wrap">
  <a href="/log_assets/markdown/032_한국 팀이 실리콘밸리에서 채용할 수 있을까.html" class="cat-nav-item cat-nav-left"><span class="cat-nav-label">❮ 이전글</span><span class="nav-title">한국 팀이 실리콘밸리에서 채용할 수 있을까</span></a>
