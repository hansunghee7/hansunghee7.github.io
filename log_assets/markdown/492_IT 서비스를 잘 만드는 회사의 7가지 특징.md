...
category: '스타트업 인사이트'
image: '/log_assets/images/494_IT 서비스를 잘 만드는 회사의 7가지 특징_cover.jpg'
date_string: 'Jan 25. 2024'
date: 2024-01-25
keywords: 'IT 서비스 조직문화, 서비스 기획 프로세스, 프로덕트 조직 운영'
about: '조직문화, 서비스 기획, 프로덕트 운영'
---
...
<div class="category-nav-wrap">
  <a href="/log_assets/markdown/523_%EC%8B%AC%ED%94%8C%EB%A6%AC%ED%8C%8C%EC%9D%B4%EC%96%B4%20%EC%9B%A8%EC%9D%B4%20%27%EC%9A%94%EA%B8%B0%EC%9A%94%20Concept%20UX%27.html" class="cat-nav-item cat-nav-left"><span class="cat-nav-label">❮ 이전글</span><span class="nav-title">심플리파이어 웨이 '요기요 Concept UX'</span></a>
