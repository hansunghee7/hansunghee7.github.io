...
<div class="category-nav-wrap">
  <a href="/log_assets/markdown/543_늘 배우는 자세.html" class="cat-nav-item cat-nav-left"><span class="cat-nav-label">❮ 이전글</span><span class="nav-title">늘 배우는 자세</span></a>
  <a href="/log_assets/markdown/539_기획자는 개발을 어디까지 알아야 할까요.html" class="cat-nav-item cat-nav-right"><span class="nav-title">기획자는 개발을 어디까지 알아야 할까요?</span><span class="cat-nav-label">다음글 ❯</span></a>
</div>
<!-- CATEGORY_NAV_END -->
