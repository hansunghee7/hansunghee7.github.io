...
<div class="category-nav-wrap">
  <a href="/log_assets/markdown/361_UX%20%EC%84%A4%EA%B3%84%EB%A5%BC%20%EC%9E%98%ED%95%98%EB%8A%94%20%EB%B2%95.html" class="cat-nav-item cat-nav-left"><span class="cat-nav-label">'스타트업 인사이트'의 이전글</span><span class="nav-title">UX 설계를 잘하는 법</span></a>
  <a href="/log_assets/markdown/384_C%EC%9D%98%20%EC%9D%98%EB%AF%B8%EB%8A%94.html" class="cat-nav-item cat-nav-right"><span class="nav-title">C의 의미는?</span><span class="cat-nav-label">'스타트업 인사이트'의 다음글</span></a>
</div>
<!-- CATEGORY_NAV_END -->
