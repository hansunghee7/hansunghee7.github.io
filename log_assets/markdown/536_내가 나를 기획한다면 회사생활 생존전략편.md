...
<div class="category-nav-wrap">
  <a href="/log_assets/markdown/535_약속과 사명의 기획.html" class="cat-nav-item cat-nav-left"><span class="cat-nav-label">❮ 이전글</span><span class="nav-title">약속과 사명의 기획</span></a>
  <a href="/log_assets/markdown/538_내가 나를 기획한다면 마인드관리편.html" class="cat-nav-item cat-nav-right"><span class="nav-title">내가 나를 기획한다면? 마인드관리편</span><span class="cat-nav-label">다음글 ❯</span></a>
</div>
<!-- CATEGORY_NAV_END -->
