...
<div class="category-nav-wrap">
  <a href="/log_assets/markdown/406_기획자가 되는 길.html" class="cat-nav-item cat-nav-left"><span class="cat-nav-label">❮ 이전글</span><span class="nav-title">기획자가 되는 길</span></a>
  <a href="/log_assets/markdown/414_CPO가 되려면 어떻게 해야 할까요.html" class="cat-nav-item cat-nav-right"><span class="nav-title">CPO가 되려면 어떻게 해야 할까요?</span><span class="cat-nav-label">다음글 ❯</span></a>
</div>
<!-- CATEGORY_NAV_END -->
