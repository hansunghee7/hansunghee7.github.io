...
<img width="1280" height="653" loading="lazy" src="/log_assets/images/165_Perplexity #2 검색 시스템의 구조 설계_img_1.png" alt="쿼리를 라우팅하는 시맨틱 라우터 구조도">
...
<img width="1201" height="594" loading="lazy" src="/log_assets/images/165_Perplexity #2 검색 시스템의 구조 설계_img_2.jpg" alt="키워드 벡터 하이브리드 검색 관계를 표현한 궤도형 다이어그램">
...
<img width="1280" height="960" loading="lazy" src="/log_assets/images/165_Perplexity #2 검색 시스템의 구조 설계_img_3.png" alt="BM25 알고리즘의 문서 매칭 벤 다이어그램">
...
<img width="1280" height="610" loading="lazy" src="/log_assets/images/165_Perplexity #2 검색 시스템의 구조 설계_img_4.png" alt="벡터DB 검색 후 리랭커로 재정렬하는 손그림 다이어그램">
...
<img width="1089" height="599" loading="lazy" src="/log_assets/images/165_Perplexity #2 검색 시스템의 구조 설계_img_5.webp" alt="퍼플렉시티 AI 핵심 기능과 버전을 정리한 마인드맵">
