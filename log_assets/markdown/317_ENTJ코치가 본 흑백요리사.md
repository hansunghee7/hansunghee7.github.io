...
<div class="category-nav-wrap">
  <a href="/log_assets/markdown/316_[모집공고] 스왈로우즈와 함께 할 스타트업을 찾습니다.html" class="cat-nav-item cat-nav-left"><span class="cat-nav-label">❮ 이전글</span><span class="nav-title">[모집공고] 스왈로우즈와 함께 할 스타트업을 찾습니다</span></a>
  <a href="/log_assets/markdown/319_스왈로우즈팀은 어떤 재능을 가지고 있나요.html" class="cat-nav-item cat-nav-right"><span class="nav-title">스왈로우즈팀은 어떤 재능을 가지고 있나요?</span><span class="cat-nav-label">다음글 ❯</span></a>
</div>
<!-- CATEGORY_NAV_END -->
