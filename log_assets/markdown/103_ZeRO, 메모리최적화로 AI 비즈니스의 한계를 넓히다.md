...
<img width="731" height="331" loading="lazy" src="/log_assets/images/103_ZeRO, 메모리최적화로 AI 비즈니스의 한계를 넓히다_img_1.jpg" alt="ZeRO 적용 전후 GPU별 메모리 사용량 비교 다이어그램">
...
<img width="1280" height="720" loading="lazy" src="/log_assets/images/103_ZeRO, 메모리최적화로 AI 비즈니스의 한계를 넓히다_img_2.jpg" alt="레이어 간 연결 구조를 나타낸 신경망 다이어그램">
