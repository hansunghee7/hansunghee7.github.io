...
<div class="category-nav-wrap">
  ...
  <a href="/log_assets/markdown/288_초기 스타트업 빌드업의 원칙.html" class="cat-nav-item cat-nav-right"><span class="nav-title">초기 스타트업 빌드업의 원칙</span><span class="cat-nav-label">다음글 ❯</span></a>
</div>
<!-- CATEGORY_NAV_END -->
