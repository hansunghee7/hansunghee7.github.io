...
<div class="category-nav-wrap">
  ...
  <a href="/log_assets/markdown/426_%EB%A6%AC%EB%8D%94%EC%9D%98%20%EC%8B%9C%EA%B0%84%EA%B4%80%EB%A6%AC%20%EC%A0%84%EB%9E%B5.html" class="cat-nav-item cat-nav-right"><span class="nav-title">리더의 시간관리 전략</span><span class="cat-nav-label">'스타트업 인사이트'의 다음글</span></a>
</div>
<!-- CATEGORY_NAV_END -->
