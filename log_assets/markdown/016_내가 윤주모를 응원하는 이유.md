...
<div class="category-nav-wrap">
  <a href="/log_assets/markdown/015_커리어가 꼬이는 이유.html" class="cat-nav-item cat-nav-left"><span class="cat-nav-label">❮ 이전글</span><span class="nav-title">커리어가 꼬이는 이유</span></a>
  <a href="/log_assets/markdown/017_요시가 만든  '근성의 스노우볼'.html" class="cat-nav-item cat-nav-right"><span class="nav-title">요시가 만든  '근성의 스노우볼</span><span class="cat-nav-label">다음글 ❯</span></a>
</div>
<!-- CATEGORY_NAV_END -->
