...
category: 'AI의 언어들'
image: '/log_assets/images/127_분산 학습, AI 비즈니스 경쟁력을 좌우하는 핵심 기술_cover.jpg'
date_string: 'May 28. 2025'
date: 2025-05-28
keywords: '분산 학습, AI 인프라 전략, GPU 클러스터'
about: 'AI 인프라, 머신러닝 학습 기술'
---
...
![데이터 병렬화와 모델 병렬화 구조를 비교한 다이어그램](//img1.kakaocdn.net/thumb/R1280x0.fpng/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/5UQYlVUvU4O6QXq3ed01Ofm69AQ.png)

## 데이터 병렬화 vs 모델 병렬화, 전략적 선택
...
![쿠버네티스 기반 분산 학습 인프라 구성도, Pod와 스토리지 연결 구조](//img1.kakaocdn.net/thumb/R1280x0.fpng/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/Gt3C_nV51Ax2A89g1T569rRNNmY.png)
