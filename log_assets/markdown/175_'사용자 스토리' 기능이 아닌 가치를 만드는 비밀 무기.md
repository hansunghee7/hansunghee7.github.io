...
category: 'PO의 프레임웍'
image: '/log_assets/images/175_사용자 스토리 기능이 아닌 가치를 만드는 비밀 무기_cover.jpg'
date_string: 'Apr 11. 2025'
date: 2025-04-11
keywords: '사용자 스토리 작성법, INVEST 원칙, 애자일 요구사항 정의'
about: '애자일 방법론, 요구사항 정의'
---
...
![사용자 스토리의 제목, 설명, 완료 기준 구성 요소를 보여주는 다이어그램](//img1.kakaocdn.net/thumb/R1280x0.fpng/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/PlrPU3FDBNA_8YTveqYrsLfOiIM.png)
...
![제품 백로그에서 에픽, 사용자 스토리, 태스크로 이어지는 구조도](//img1.kakaocdn.net/thumb/R1280x0.fpng/?fname=http://t1.daumcdn.net/brunch/service/user/5lk/image/CxSf9zPbKqIV0qKtblWO8ZhTZ-c.png)
