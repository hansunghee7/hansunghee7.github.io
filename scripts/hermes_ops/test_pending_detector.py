...
class DetectorTest(unittest.TestCase):
    def setUp(self):
        ...
        (self.writer / "tasks" / "pending").mkdir(parents=True)
        (self.writer / "tasks" / "pending" / ".gitkeep").write_text("")
    ...
    def push_pending(self, name):
        (self.writer / "tasks" / "pending" / name).write_text("# 시험 지시서\n")
        git(self.writer, "add", "-A")
